  ...
  return (
    <div className='text-gray-400 '>
                   <div className="mt-8 flex p-3">
                       <img className="h-15 w-10 rounded-full mr-3" style={{objectFit: 'contain'}} src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.shareicon.net%2Fdata%2F2016%2F05%2F24%2F770117_people_512x512.png&f=1&nofb=1" alt="" />
                       <div>
                           <div>
